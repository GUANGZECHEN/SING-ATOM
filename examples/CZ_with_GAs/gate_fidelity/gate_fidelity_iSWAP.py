...
def test_Choi_noisy_iSWAP(Gamma,Gamma_phi):    # g=1
  options=Options() 
  times=[0,np.pi/2]
  
  # for testing
  Phi=tensor([p0,p0,p1,p0])
  ...
  H=tensor([id3,id3,s10,s01])+tensor([id3,id3,s01,s10])
...
np.savetxt("Fidelity_iSWAP_vs_Gp.OUT", np.transpose([Gps,r1,r2,r3,r4]))
np.savetxt("Fidelity_iSWAP_vs_G1.OUT", np.transpose([Gps,R1,R2,R3,R4]))
